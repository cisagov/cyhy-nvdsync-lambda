...
issue](https://github.com/cisagov/cyhy-nvdsync-lambda/issues) in this
...
request](https://github.com/cisagov/cyhy-nvdsync-lambda/pulls), you will
...
```console
cd cyhy-nvdsync-lambda
pyenv virtualenv <python_version_to_use> cyhy-nvdsync-lambda
pyenv local cyhy-nvdsync-lambda
